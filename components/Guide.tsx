  ...
  return (
    <section className="flexCenter flex-col">
      ...
      <div className="flexCenter max-container relative w-full">
        ...
        />
        <div className="absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl broder shadow-md md:left-[5%] lg:top-20">
          <Image
            src="/meter.svg"
            alt="meter"
            width={16}
          ...
          <div className="flexBetween flex-col">
            ...
            <div className="flex w-full flex-col">
              ...
              <p className="bold-20 mt-2 no-wrap">Wonorejo Pasuruan</p>
            </div>
          </div>
        </div>
      </div>
